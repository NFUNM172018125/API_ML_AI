...
| 对比平台 | 学而思 | 讯飞 | 总结 | 
| :------:| :------: | :------: | :------ |
| API市场竞争程度 | 必应搜索排名第二 | 必应搜索排名第一 | 讯飞的排名虽然在搜索引擎排名靠前，且有调用demo，但仍然处于为测试版，性能和效果仍有待提高。学而思虽然排名靠后，但是其上线以来累计判题数超3亿,且学而思专注于教育方面。 | 
...
#### API加分项
* 用到的的api有学而思网校AI开放平台OCR速算API、讯飞语音合成API、百度AI拍照翻译SDKAPI
